...
This public repository is the canonical source for GitHub-supported community-health fallbacks, organization profile content, contribution guidance, public security/support policy, issue and pull-request templates, and agent-governance declarations for [`embedded-alerts`](https://github.com/embedded-alerts).

## Canonical organization links

- GitHub organization: https://github.com/embedded-alerts
- Public organization defaults: https://github.com/embedded-alerts/.github
